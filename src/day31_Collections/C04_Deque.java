...
public class C04_Deque {
    public static void main(String[] args) {
        ...
        // iki yonlu kuyruk
        //basa da sona da ekler veya cikarir yani hem fifo,hem filo ozelligi vardir
        //biz ozellikle istemezsek sona ekler
        //pek cok firs ve last li methodu var cunki hem basa hem sona ekleyebilir
        Deque<String>harfler=new LinkedList<>();
        harfler.add("J");
        harfler.add("L");
        System.out.println(harfler);//J L
        harfler.addFirst("B");//B yi one ekle dedik
