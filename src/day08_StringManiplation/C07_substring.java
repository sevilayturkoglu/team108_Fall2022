...
public class C07_substring {
    public static void main(String[] args) {
        ...
        // ornegin "ogren" kelimesini yazdiralim,bunun icin charAt kullanamayiz,cunki charAt tek karakter alir
        ...
        System.out.println(str.indexOf("kap"));//kap 16.indexten  basliyor,baslangic indexini ogrendik substring de kullanabilirim
